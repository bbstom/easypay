...
const DEFAULT_TEMPLATES = {
  ...
  help_center: {
    ...
    buttons: [
      { text: '« 返回主菜单', type: 'callback', data: 'back_to_main', row: 0, col: 0 }
    ]
  },
  help_faq: {
    name: '常见问题',
    ...
    variables: [],
    buttons: [
      { text: '💬 联系客服', type: 'callback', data: 'create_ticket', row: 0, col: 0 },
      { text: '« 返回主菜单', type: 'callback', data: 'back_to_main', row: 1, col: 0 }
    ]
  },
  help_contact: {
    name: '联系客服',
    ...
    variables: [],
    buttons: [
      { text: '📝 创建工单', type: 'callback', data: 'create_ticket', row: 0, col: 0 },
      { text: '« 返回主菜单', type: 'callback', data: 'back_to_main', row: 1, col: 0 }
    ]
  },
  help_tutorial: {
    ...
    variables: [],
    buttons: [
      { text: '💬 联系客服', type: 'callback', data: 'help_contact', row: 0, col: 0 },
      { text: '« 返回主菜单', type: 'callback', data: 'back_to_main', row: 1, col: 0 }
    ]
  }
};
